  ...
  <div id="container2" v-if="view===2">
    ...
    <div class="basic">
      ...
      <div id="down_btn">
        ...
        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <a href="join_linebot.html"><button @click="register_patient"  id="check_writing" type="submit"  style="width:150px;height:50px;background-color: #00317B;color:white;text-align: center;border:0" >確認送出</button></a>
        <br>
      </div>
    </div>
    <br><br>
