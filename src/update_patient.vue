  ...
  <div id="container1" >
    ...
    <div class="basic">
      ...
      <div id="down_btn">
        ...
        <button @click="update_patient_info_by_id"   id="check_writing" type="submit"  style="width:150px;height:50px;background-color: #00317B;color:white;text-align: center;border:0" >確認填寫</button>
        <br>
      </div>
    </div>
    <br><br>
